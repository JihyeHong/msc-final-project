...
# -------------- Data Import --------------
df = pd.read_csv('../data/data_days_BTC.csv')

print('--------------Data imported--------------')
print(df.head())

# Pairs
pairs = ['ETH','XLM','EOS','BCH','XRP','ETC','XMR','DASH','LTC','MLN','ZEC','REP','ICN','GNO']
...
print('***********Forecasting***********')
# -------------- Prediction with SVM --------------
print('--------------ETH_BTC Prediction with SVM--------------')
coin = 'ETH'
...
# -------------- Prediction with NB --------------
print('--------------ETH_BTC Prediction with NB--------------')
accuracy_list2 = []
...
# -------------- Prediction with KNN --------------
print('--------------ETH_BTC Prediction with KNN--------------')
...
df_accuracy.to_csv('output_approach2_ETHBTC.csv')
...
print('--------------ETH_BTC Prediction with a naive approach--------------')
...
plot_confusion_matrix(cnf_matrix, classes=[-1,1],
                      title='Confusion matrix for {}'.format('ETH_BTC with a naive model') )
