...
print('Approach 1 using real-time API data')
...
def test_knn(timeUnit, limit):
    ...
    for pair in pairs:
        price_data[pair] = get_cryptocompare_data(timeUnit, pair, 'USD', limit, 'Kraken')
...
print('===== Approach 1.1 for minute data ===== ')
test_knn('minute',2000)
...
print('===== Approach 1.2 for minute data ===== ')
test_knn2('minute',2000)
